...
{
    "Amygdalan Arm",
            0.6f, 0.15f, 0.0f, 0.41f,
            0.03f, 0.01f, 0.0f, 0.02f,
            1.0f, 1.3f, 1.8f, 1.15f, 0.95f, 1.2f, 1.7f, 0.0f, 1.5f, 
            80, 40, 0, 8, 4, 0, 8, 4, 0
        },
{
    "Beasthunter Saif",
            0.2f, 0.4f, 0.0f, 0.33f,
            0.01f, 0.03f, 0.0f, 0.02f,
...
{
    "Bloodletter",
            0.6f, 0.0f, 0.7f, 0.33f,
            0.04f, 0.0f, 0.04f, 0.02f,
...
{
    "Rakuyo",
            0.0f, 0.6f, 0.0f, 0.33f,
            0.0f, 0.04f, 0.0f, 0.02f,
            1.0f, 1.35f, 1.7f, 1.3f, 1.0f, 0.9f, 0.0f, 1.95f, 1.5f,
            82, 0, 0, 8, 0, 0, 10, 0, 0
    },
{
    "Simon's Bowblade",
            0.6f, 0.6f, 0.6f, 0.33f,
            0.0f, 0.05f, 0.05f, 0.02f,
            1.0f, 1.3f, 2.5f, 0.85f, 0.85f, 1.05f, 1.4f, 0.7f, 1.35f,
            80, 0, 80, 8, 0, 8, 8, 0, 8
    },
{
    "Whirligig Saw",
            0.7f, 0.2f, 0.0f, 0.49f,
            0.04f, 0.01f, 0.0f, 0.3f,
