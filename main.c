...
int main() {
  ...
  float strScale, strSat, skillScale, skillSat, bloodtingeScale, bloodtingeSat,
      arcScale, arcSat;

  float weaponStrScale, weaponSkillScale, weaponBloodtingeScale,
      weaponArcaneScale;
